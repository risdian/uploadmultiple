            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/vendors" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="ic_no" class="col-md-4 col-form-label text-md-right">{{ __('Identification No.') }}</label>

                            <div class="col-md-6">
                                <input id="ic_no" type="text" class="form-control @error('ic_no') is-invalid @enderror" name="ic_no" value="{{ old('ic_no') }}" autocomplete="ic_no" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="poscode" class="col-md-4 col-form-label text-md-right">{{ __('Poscode') }}</label>

                            <div class="col-md-6">
                                <input id="poscode" type="text" class="form-control @error('poscode') is-invalid @enderror" name="poscode" value="{{ old('poscode') }}" autocomplete="poscode" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="photos" type="file" class="form-control @error('photos') is-invalid @enderror" name="photos[]" value="{{ old('photos') }}" autocomplete="photos" multiple  autofocus>
